...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.Liip\\FunctionalTestBundle\\Command\\RunParatestCommand' => 'getRunParatestCommandService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'\\vendor\\liip\\functional-test-bundle\\src\\EventListener\\ExceptionListener.php';
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'LiipFunctionalTestBundle' => [
                    'path' => ($this->targetDirs[3].'\\vendor\\liip\\functional-test-bundle\\src'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.Liip\\FunctionalTestBundle\\Command\\RunParatestCommand',
            ],
        ];
    }
}
